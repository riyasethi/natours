...
})({"ltzfi":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "353957168c19a56c";
module.bundle.HMR_BUNDLE_ID = "aafc9c48fd75fa00";
"use strict";
...
(function(modules, entry, mainEntry, parcelRequireName, globalName) {
    ...
    function newRequire(name, jumped) {
        ...
        return cache[name].exports;
        function localRequire(x) {
            var res1 = localRequire.resolve(x);
            return res1 === false ? {} : newRequire(res1);
        }
        function resolve(x) {
            var id = modules[name][1][x];
            return id != null ? id : x;
    ...
    "ltzfi": [
        function(require, module1, exports) {
            ...
            var HMR_SECURE = false;
            var HMR_ENV_HASH = "353957168c19a56c";
            module1.bundle.HMR_BUNDLE_ID = "aafc9c48fd75fa00";
            "use strict";
            /* global HMR_HOST, HMR_PORT, HMR_ENV_HASH, HMR_SECURE, chrome, browser, __parcel__import__, __parcel__importScripts__, ServiceWorkerGlobalScope */ /*::
import type {
  HMRAsset,
...
${frame.code}`;
    ...
    "d75bL": [
        ...
        {
            "@parcel/transformer-js/src/esmodule-helpers.js": "4SuGQ"
        }
    ],
    "4SuGQ": [
        function(require, module1, exports) {
        ...
        function(require, module1, exports) {
            ...
            const updateSettings = async (data, type)=>{
                try {
                    ...
                    if (res1.data.status === "success") (0, _alerts.showAlert)("success", `${type.toUpperCase()} updated successfully!`);
                } catch (err) {
                    (0, _alerts.showAlert)("error", err.response.data.message);
                }
            };
    ...
    "ltzfi",
    "37pvV"
], "37pvV", "parcelRequire11c7");

},{}]},["ltzfi","37pvV"], "37pvV", "parcelRequire11c7")
